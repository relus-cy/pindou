    ...
    return new Promise<string>((resolve) => {
      ...
      userImg.onload = () => {
        if (isUsingPixelArt) {
          ...
          ctx.fillText('meowmeow拼豆', cardWidth / 2, cardHeight - 50);
          ctx.font = '12px system-ui, -apple-system, BlinkMacSystemFont, "Segoe UI", sans-serif';
          ctx.fillStyle = 'rgba(255,255,255,0.5)';
          ctx.fillText('pd.meowmeowmoon.com', cardWidth / 2, cardHeight - 25);
          ...
          if (thumbnailDataURL) {
            ...
            thumbnailImg.onload = () => {
              ...
              ctx.shadowColor = 'rgba(0,0,0,0.5)';
              ctx.shadowBlur = 4;
              ctx.fillText('meowmeow拼豆', cardWidth / 2, cardHeight - 40);
              ctx.font = '12px system-ui, -apple-system, BlinkMacSystemFont, "Segoe UI", sans-serif';
              ctx.fillStyle = 'rgba(255,255,255,0.6)';
              ctx.fillText('pd.meowmeowmoon.com', cardWidth / 2, cardHeight - 20);
              ctx.shadowBlur = 0;
